...
public class AesEncryptDecryptUtils {
    ...
    public static String genAes256Key() throws NoSuchAlgorithmException {
        ...
        return encoder.encodeToString(keyGenerator.generateKey().getEncoded());
    }

    public static String doEncryptAesCbcNoPadding(String secretKey, String iv, String value) throws Exception {
        SecretKeySpec keySpec = new SecretKeySpec(Base64.decode(secretKey), AES_ENCRYPT);
    ...
    public static String doDecryptAesCbcNoPadding(String secretKey, String iv, String value) throws Exception {
        SecretKeySpec keySpec = new SecretKeySpec(Base64.decode(secretKey), AES_ENCRYPT);
        Cipher cipher = Cipher.getInstance(AES_CBC_NO_PADDING);
        byte[] initParam = iv.getBytes("UTF-8");
        IvParameterSpec ivParameterSpec = new IvParameterSpec(initParam);
